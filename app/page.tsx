...
export default function Home() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[var(--color-bg-primary)] text-[var(--color-text-primary)]">
      <h1 className="text-[var(--color-accent-primary)] text-6xl leading-none" style={{ fontFamily: "Georgia, 'Times New Roman', serif" }}>
        茶
      </h1>
      <p className="font-semibold text-2xl tracking-wide mt-4 mb-8 text-[var(--color-accent-primary)]">
        Tea timer
      </p>
